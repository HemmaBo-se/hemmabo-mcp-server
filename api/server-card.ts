...
export default function handler(_req: VercelRequest, res: VercelResponse) {
  res.json({
    ...
    tools: [
      ...
      {
        name: "hemmabo.search.availability",
        description:
      ...
      {
        name: "hemmabo.manage.reschedule",
        description:
